...
public class PhysicsObject : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
    	//we want to move our object downward because it is being affected
    	//by gravity every frame.
    	...
    	//the direction we are trying to move along the ground if ground is a slop
